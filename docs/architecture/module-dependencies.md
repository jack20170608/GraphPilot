...
graph TD
    ...
    class DOMAIN domain
    class APP app
    class WEB,MYBATIS,MEMORY,WORKER,WORKER_SPRING,WORKER_MICRONAUT adapter
    class BS_SPRING,BS_MICRONAUT bootstrap
```
...
| `graphpilot-bootstrap-spring` | `graphpilot-application`、`graphpilot-adapter-web-spring`、`graphpilot-adapter-persistence-memory`、`graphpilot-adapter-persistence-mybatis`、`graphpilot-adapter-worker-spring` |
